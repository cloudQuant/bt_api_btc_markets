...
[![PyPI Version](https://img.shields.io/pypi/v/bt_api_btc_markets.svg)](https://pypi.org/project/bt_api_btc_markets/)
[![Python Versions](https://img.shields.io/pypi/pyversions/bt_api_btc_markets.svg)](https://pypi.org/project/bt_api_btc_markets/)
[![License](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![CI](https://github.com/cloudQuant/bt_api_btc_markets/actions/workflows/ci.yml/badge.svg)](https://github.com/cloudQuant/bt_api_btc_markets/actions)
[![Docs](https://readthedocs.org/projects/bt-api-btc-markets/badge/?version=latest)](https://bt-api-btc-markets.readthedocs.io/)
...
This package provides **BTC Markets exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BTC_MARKETS** exchange.
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **BTC Markets exchange plugin for bt_api**。它提供了与 **BTC_MARKETS** 交易所交互的统一接口。
